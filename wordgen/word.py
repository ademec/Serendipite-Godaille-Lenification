...
from constants import ALPHA, DATA_FOLDER, SURNAME_MODEL3D_FILENAME, LASTNAME_MODEL3D_FILENAME
...
def gen_surname():
	with open(DATA_FOLDER + SURNAME_MODEL3D_FILENAME, "r") as f:
...
def gen_lastname():
	with open(DATA_FOLDER + LASTNAME_MODEL3D_FILENAME, "r") as f:
